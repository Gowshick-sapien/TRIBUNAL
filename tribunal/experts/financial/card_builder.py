"""Card Builder module — Translates aggregated findings into InvestigationCard domain objects."""
...
from tribunal.experts.financial.confidence import AggregatedFinding
...
class CardBuilder:
    ...
    def build_cards(self, aggregated_findings: list[AggregatedFinding]) -> list[InvestigationCard]:
        ...
        for idx, finding in enumerate(aggregated_findings, start=1):
            ...
            card_id = f"card_fin_{idx:03d}_{uuid.uuid4().hex[:6]}"
